...
## Busy Beaver Introduction (5/1/2026)

An introductory lecture to Turing Machines and the Busy Beaver problem.

[Slides](https://shoesareme.github.io/projects/lectures/codeplusplus/busybeaver.pdf)
...
An introductory lecture to the problem of $$\mathsf{P} \overset{?}{=} \mathsf{NP}$$. The lecture is quite advanced, however.

This presentation was originally made in 12/25/2025, but due to scheduling conflicts it had to be pushed back several months.

[Slides](https://shoesareme.github.io/projects/lectures/codeplusplus/pnp.pdf)
